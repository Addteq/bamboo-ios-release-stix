...
typedef enum {
    myAFFormURLParameterEncoding,
    myAFJSONParameterEncoding,
    myAFPropertyListParameterEncoding,
} myAFHTTPClientParameterEncoding;

@class AFHTTPRequestOperation;
@protocol myAFMultipartFormData;

@interface myAFHTTPClient : NSObject <NSCoding, NSCopying>
 ...
 */
@property (nonatomic, assign) myAFHTTPClientParameterEncoding parameterEncoding;
 ...
 */
extern NSString * myAFQueryStringFromParametersWithEncoding(NSDictionary *parameters, NSStringEncoding encoding);
 ...
 */
#ifdef _SYSTEMCONFIGURATION_H
extern NSString * const myAFNetworkingReachabilityDidChangeNotification;
extern NSString * const myAFNetworkingReachabilityNotificationStatusItem;
#endif

#pragma mark -

extern NSUInteger const mykAFUploadStream3GSuggestedPacketSize;
extern NSTimeInterval const mykAFUploadStream3GSuggestedDelay;
