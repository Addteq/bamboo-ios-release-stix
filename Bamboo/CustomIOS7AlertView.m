...
const static CGFloat kCustomIOS7AlertViewCornerRadius              = 9;
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton addTarget:self action:@selector(customIOS7dialogButtonTouchDown:) forControlEvents:UIControlEventTouchDown];
        [closeButton addTarget:self action:@selector(customIOS7dialogButtonTouchDragExit:) forControlEvents:UIControlEventTouchDragExit];
        [closeButton setTag:i];

        [closeButton setTitle:[buttonTitles objectAtIndex:i] forState:UIControlStateNormal];
        [closeButton setTitleColor:[UIColor colorWithRed:0.0f green:0.48f blue:1.0f alpha:1.0f] forState:UIControlStateNormal];
        [closeButton setTitleColor:[UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:1.0f] forState:UIControlStateHighlighted];
        [closeButton.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:16.0f]];
...
- (IBAction)customIOS7dialogButtonTouchDown: (id)sender{
    NSLog(@"touch down");
    UIButton *button = (UIButton *)sender;
    [button setBackgroundColor:[UIColor colorWithRed:0.0f green:0.48f blue:1.0f alpha:1.0f]];
    button.titleLabel.textColor= [UIColor whiteColor];
}
- (IBAction)customIOS7dialogButtonTouchDragExit: (id)sender{
    NSLog(@"touch down");
    UIButton *button = (UIButton *)sender;
